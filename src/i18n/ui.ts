...
export const ui = {
  en: {
    ...
    'detail.security.fullReport': 'Full report',
    'detail.security.reportHeading': 'Vulnerability detail',
    'detail.security.colCve': 'CVE',
    'detail.security.colSeverity': 'Severity',
    'detail.security.colPackage': 'Package',
    'detail.security.colInstalled': 'Installed',
    'detail.security.colFixed': 'Fixed in',
    'detail.security.colTitle': 'Title',
    'detail.security.notFixable': 'not fixable',
    'detail.security.close': 'Close',
  ...
  ar: {
    ...
    'detail.security.fullReport': 'التقرير الكامل',
    'detail.security.reportHeading': 'تفاصيل الثغرات',
    'detail.security.colCve': 'الثغرة (CVE)',
    'detail.security.colSeverity': 'الخطورة',
    'detail.security.colPackage': 'الحزمة',
    'detail.security.colInstalled': 'الإصدار المثبَّت',
    'detail.security.colFixed': 'مُصلَحة في',
    'detail.security.colTitle': 'الوصف',
    'detail.security.notFixable': 'غير قابلة للإصلاح',
    'detail.security.close': 'إغلاق',
  ...
  es: {
    ...
    'detail.security.fullReport': 'Informe completo',
    'detail.security.reportHeading': 'Detalle de vulnerabilidades',
    'detail.security.colCve': 'CVE',
    'detail.security.colSeverity': 'Gravedad',
    'detail.security.colPackage': 'Paquete',
    'detail.security.colInstalled': 'Instalada',
    'detail.security.colFixed': 'Corregida en',
    'detail.security.colTitle': 'Título',
    'detail.security.notFixable': 'sin corrección',
    'detail.security.close': 'Cerrar',
